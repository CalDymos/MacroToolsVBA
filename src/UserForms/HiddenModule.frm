...
'* Argument(s):         Description
'*
'* FilePath As String : - директори€ файла
'*
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : ByteArrayToFile - «аписывает в файл маcсив байтов
'* Created    : 14-02-2020 08:42
'* Author     : VBATools
'* Contacts   : -
'* Copyright  : Byte Ranger Software
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Function   : ByteArrayFromFile - ќткрывает бинарный файл и создает одномерный массив байтов
'* Created    : 14-02-2020 08:42
'* Author     : VBATools
'* Contacts   : -
'* Copyright  : Byte Ranger Software
