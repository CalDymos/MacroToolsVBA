...
Private frmProgressBar As ProgressBar
...
Sub UpdateProgressBar(Percentage As Long, Optional Total As Long = 100)

          'Allow Updates
190       DoEvents
191       If Not frmProgressBar Is Nothing Then
192           With frmProgressBar

                  'Set width of the bar
193               .lblBar.Width = .Frame1.Width * Percentage / Total

                  'Percentage
194               .lblPercent.Caption = Round(Percentage / Total * 100, 0) & "%"

195           End With
196       End If
End Sub

Sub ShowProgressBar(bShow As Boolean, Optional sTitle As String = "Please wait...")

197       If bShow Then
198           Set frmProgressBar = New ProgressBar
199           frmProgressBar.Caption = sTitle
200           frmProgressBar.lblBar.Width = 0
201           frmProgressBar.lblPercent = "0%"
202           frmProgressBar.Show vbModeless
203       Else
204           frmProgressBar.Hide
205           Unload frmProgressBar
206           Set frmProgressBar = Nothing
207       End If

End Sub

Sub ResetProgressBar(Optional sTitle As String = "Please wait...")

208       If Not frmProgressBar Is Nothing Then
209           frmProgressBar.Caption = sTitle
210           frmProgressBar.lblBar.Width = 0
211           frmProgressBar.lblPercent = "0%"
