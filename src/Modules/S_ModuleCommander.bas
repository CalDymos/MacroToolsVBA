...
34:    Exit Sub
Error_Handler_:
36:    Call MsgBox("Mistake! in ImportAllModules" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl, vbCritical, "Mistake:")
...
51:        Exit Sub
52:    End If
53:    If MsgBox("Do you want to export all modules from the book -" & wb.Name & " ?" & vbCrLf & vbCrLf & "Export to a folder:" & sDestinationFolder, vbYesNo, "Uploading a project:") = vbNo Then Exit Sub
...
85:    Exit Sub
Error_Handler_:
87:    Call MsgBox("Mistake! in ExportAllModules" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl, vbCritical, "Mistake:")
...
98:    If MsgBox("Do you want to remove all code modules in an active VBA project?, from the book -" & wb.Name, vbYesNo, "Deleting a project:") = vbNo Then Exit Sub
99:    If MsgBox("PLEASE CONFIRM-DELETING THE CODE IS NOT A REVERSIBLE ACTION" & vbCrLf & vbCrLf & "Do you want to remove all the code from the active VBA project?, from the book -" & wb.Name, vbYesNo, "Deleting a project:") = vbNo Then Exit Sub
...
117:    If r + m > 0 Then MsgBox "Modules removed:" & m & vbCrLf & "References removed:" & r, vbInformation, ""
118:    Exit Sub
Error_Handler_:
120:    Call MsgBox("Mistake! in DeleteAllModulesInActiveProject" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl, vbCritical, "Mistake:")
...
132:        Call MsgBox("VBA project in the book -" & wb.Name & "password protected!" & vbCrLf & "Remove the password!", vbCritical, "Mistake:")
...
144:
145:    If C = 0 Then
146:        Call MsgBox("Exporting a VBA project - in a book:" & wb.Name & "there is no VBA project!", vbCritical, "No VBA project:")
...
153:    Exit Function
Error_Handler_:
155:    Call MsgBox("Mistake! in DoesActiveVBAprojectExist" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl, vbCritical, "Mistake:")
...
190:    Call MsgBox("Mistake! in RemoveAllReferences" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl, vbCritical, "Mistake:")
191: End Function
