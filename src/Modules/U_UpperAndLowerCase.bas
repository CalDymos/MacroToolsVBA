...
49:    Select Case Err.Number
        Case 0
51:        Case Else
52:            Debug.Print "Mistake! in U_UpperAndLowerCase.toUpperCase" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl
...
98:    Select Case Err.Number
        Case 0
100:        Case Else
101:            Debug.Print "Mistake! in U_UpperAndLowerCase.toLowerCase" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl
