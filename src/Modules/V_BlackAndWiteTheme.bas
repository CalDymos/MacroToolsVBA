...
20:    Call ChangeColorTheme(BACK_COLOR_WHITE_THEME, FORE_COLOR_WHITE_THEME, "The Light theme is enabled, restart MS Excel")
21: End Sub
...
55:    Exit Sub
ErrorHandler:
57:    Call MsgBox("Mistake! in V_BlackAndWiteTheme.ChangeColorTheme" & vbLf & Err.Number & vbLf & Err.Description & vbCrLf & "in the line" & Erl, vbCritical, "Mistake:")
