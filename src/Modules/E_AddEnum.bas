...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : AddModuleToProject - Erstellen eines VBA-Moduls
...
155:    Err.Clear
156: End Function
'Kopieren des Moduls fьr das Menь
...
'* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
'* Sub        : SerchVariableUnUsedInSelectedWorkBook - Code-Analyse von nicht verwendbaren Variablen
